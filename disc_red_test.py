...
sys_plot = control.ss(a, b[:, [in_plot]], c[[out_plot], :], d[[out_plot], [in_plot]], 0.1) # the SISO system (extracted from the MIMO system) to be ploted
print(sys_plot)
