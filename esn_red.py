...
from esn_red_cell import miniESN_unstable_Cell, miniESN_stable_Cell
...
class miniESN_unstable(tf.keras.layers.RNN):
...
class miniESN_stable(tf.keras.layers.RNN):
    """Reduced Echo State Network layer.
